...
public class StyleDictionary {
    ...
    public static let localNewsAlertred = rgba(210, 0, 0, 1)
    public static let localNewsAlmostblack = rgba(41, 40, 39, 1)
    public static let localNewsBlue = rgba(7, 113, 216, 1)
    public static let localNewsContainerSubtitleFontFamily = Open Sans
    public static let localNewsContainerSubtitleFontSize = 18
    public static let localNewsContainerSubtitleFontStretch = normal
    public static let localNewsContainerSubtitleFontStyle = normal
    public static let localNewsContainerSubtitleFontStyleOld = Bold
    public static let localNewsContainerSubtitleFontWeight = 700
    public static let localNewsContainerSubtitleLetterSpacing = 0
    public static let localNewsContainerSubtitleLineHeight = 26
    public static let localNewsContainerSubtitleParagraphIndent = 0
    public static let localNewsContainerSubtitleParagraphSpacing = 0
    public static let localNewsContainerSubtitleTextCase = none
    public static let localNewsContainerSubtitleTextDecoration = none
    public static let localNewsContainerTitleFontFamily = Guardian Sans
    public static let localNewsContainerTitleFontSize = 22
    public static let localNewsContainerTitleFontStretch = normal
    public static let localNewsContainerTitleFontStyle = normal
    public static let localNewsContainerTitleFontStyleOld = Black
    public static let localNewsContainerTitleFontWeight = 900
    public static let localNewsContainerTitleLetterSpacing = 0
    public static let localNewsContainerTitleLineHeight = 26
    public static let localNewsContainerTitleParagraphIndent = 0
    public static let localNewsContainerTitleParagraphSpacing = 0
    public static let localNewsContainerTitleTextCase = none
    public static let localNewsContainerTitleTextDecoration = none
    public static let localNewsFigcaptionFontFamily = Open Sans
    public static let localNewsFigcaptionFontSize = 16
    public static let localNewsFigcaptionFontStretch = normal
    public static let localNewsFigcaptionFontStyle = normal
    public static let localNewsFigcaptionFontStyleOld = Regular
    public static let localNewsFigcaptionFontWeight = 400
    public static let localNewsFigcaptionLetterSpacing = 0
    public static let localNewsFigcaptionLineHeight = 24
    public static let localNewsFigcaptionParagraphIndent = 0
    public static let localNewsFigcaptionParagraphSpacing = 0
    public static let localNewsFigcaptionTextCase = none
    public static let localNewsFigcaptionTextDecoration = none
    public static let localNewsLightergray = rgba(246, 245, 241, 1)
    public static let localNewsLightgray = rgba(231, 230, 226, 1)
    public static let localNewsParagraphFontFamily = Open Sans
    public static let localNewsParagraphFontSize = 16
    public static let localNewsParagraphFontStretch = normal
    public static let localNewsParagraphFontStyle = normal
    public static let localNewsParagraphFontStyleOld = Regular
    public static let localNewsParagraphFontWeight = 400
    public static let localNewsParagraphLetterSpacing = 0
    public static let localNewsParagraphLineHeight = 24
    public static let localNewsParagraphParagraphIndent = 0
    public static let localNewsParagraphParagraphSpacing = 0
    public static let localNewsParagraphSFontFamily = Open Sans
    public static let localNewsParagraphSFontSize = 14
    public static let localNewsParagraphSFontStretch = normal
    public static let localNewsParagraphSFontStyle = normal
    public static let localNewsParagraphSFontStyleOld = Regular
    public static let localNewsParagraphSFontWeight = 400
    public static let localNewsParagraphSLetterSpacing = 0
    public static let localNewsParagraphSLineHeight = 24
    public static let localNewsParagraphSParagraphIndent = 0
    public static let localNewsParagraphSParagraphSpacing = 0
    public static let localNewsParagraphSTextCase = none
    public static let localNewsParagraphSTextDecoration = none
    public static let localNewsParagraphTextCase = none
    public static let localNewsParagraphTextDecoration = none
    public static let localNewsTransparentgray = rgba(41, 40, 39, 0.38)
    public static let localNewsWhite = rgba(255, 255, 255, 1)
    ...
    public static let nettavisenAlertred = rgba(210, 0, 0, 1)
    public static let nettavisenBackground = rgba(245, 245, 245, 1)
    public static let nettavisenBlack = rgba(0, 0, 0, 1)
    public static let nettavisenBlue = rgba(7, 113, 216, 1)
    public static let nettavisenContainerSubtitleFontFamily = Faktor Sans
    public static let nettavisenContainerSubtitleFontSize = 19
    public static let nettavisenContainerSubtitleFontStretch = normal
    public static let nettavisenContainerSubtitleFontStyle = normal
    public static let nettavisenContainerSubtitleFontStyleOld = Bold
    public static let nettavisenContainerSubtitleFontWeight = 700
    public static let nettavisenContainerSubtitleLetterSpacing = 0
    public static let nettavisenContainerSubtitleLineHeight = 26
    public static let nettavisenContainerSubtitleParagraphIndent = 0
    public static let nettavisenContainerSubtitleParagraphSpacing = 0
    public static let nettavisenContainerSubtitleTextCase = none
    public static let nettavisenContainerSubtitleTextDecoration = none
    public static let nettavisenContainerTitleFontFamily = Faktor Sans Display
    public static let nettavisenContainerTitleFontSize = 22
    public static let nettavisenContainerTitleFontStretch = normal
    public static let nettavisenContainerTitleFontStyle = normal
    public static let nettavisenContainerTitleFontStyleOld = Black
    public static let nettavisenContainerTitleFontWeight = 900
    public static let nettavisenContainerTitleLetterSpacing = 0
    public static let nettavisenContainerTitleLineHeight = 26
    public static let nettavisenContainerTitleParagraphIndent = 0
    public static let nettavisenContainerTitleParagraphSpacing = 0
    public static let nettavisenContainerTitleTextCase = none
    public static let nettavisenContainerTitleTextDecoration = none
    public static let nettavisenDarkgray = rgba(112, 112, 112, 1)
    public static let nettavisenFigcaptionFontFamily = Faktor Sans
    public static let nettavisenFigcaptionFontSize = 17
    public static let nettavisenFigcaptionFontStretch = normal
    public static let nettavisenFigcaptionFontStyle = normal
    public static let nettavisenFigcaptionFontStyleOld = Regular
    public static let nettavisenFigcaptionFontWeight = 400
    public static let nettavisenFigcaptionLetterSpacing = 0
    public static let nettavisenFigcaptionLineHeight = 24
    public static let nettavisenFigcaptionParagraphIndent = 0
    public static let nettavisenFigcaptionParagraphSpacing = 0
    public static let nettavisenFigcaptionTextCase = none
    public static let nettavisenFigcaptionTextDecoration = none
    public static let nettavisenLightgray = rgba(227, 227, 227, 1)
    public static let nettavisenParagraphFontFamily = Faktor Sans
    public static let nettavisenParagraphFontSize = 17
    public static let nettavisenParagraphFontStretch = normal
    public static let nettavisenParagraphFontStyle = normal
    public static let nettavisenParagraphFontStyleOld = Regular
    public static let nettavisenParagraphFontWeight = 400
    public static let nettavisenParagraphLetterSpacing = 0
    public static let nettavisenParagraphLineHeight = 24
    public static let nettavisenParagraphParagraphIndent = 0
    public static let nettavisenParagraphParagraphSpacing = 0
    public static let nettavisenParagraphSFontFamily = Faktor Sans
    public static let nettavisenParagraphSFontSize = 14
    public static let nettavisenParagraphSFontStretch = normal
    public static let nettavisenParagraphSFontStyle = normal
    public static let nettavisenParagraphSFontStyleOld = Regular
    public static let nettavisenParagraphSFontWeight = 400
    public static let nettavisenParagraphSLetterSpacing = 0
    public static let nettavisenParagraphSLineHeight = 24
    public static let nettavisenParagraphSParagraphIndent = 0
    public static let nettavisenParagraphSParagraphSpacing = 0
    public static let nettavisenParagraphSTextCase = none
    public static let nettavisenParagraphSTextDecoration = none
    public static let nettavisenParagraphTextCase = none
    public static let nettavisenParagraphTextDecoration = none
    public static let nettavisenTransparentgray = rgba(0, 0, 0, 0.38)
    public static let nettavisenWhite = rgba(255, 255, 255, 1)
